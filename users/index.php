...
<br>
					...
					<input type="text" align="center" class="form-control"  name="vercode" placeholder="Verification code" maxlength="5" autocomplete="off" required  style="height:35px;" />
					<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;<img src="captcha.php" >
					</div> 
