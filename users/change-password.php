...
{
  echo "Passsword".md5($_POST['password']);
$sql=mysqli_query($con,"SELECT password FROM  user where password='".md5($_POST['password'])."' && userEmail='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
   echo "Passsword".md5($_POST['newpassword']);
 $con=mysqli_query($con,"update user set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where userEmail='".$_SESSION['login']."'");
