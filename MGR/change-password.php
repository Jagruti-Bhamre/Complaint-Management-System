...
{
$sql=mysqli_query($con,"SELECT mgr_pass FROM  manager where mgr_pass='".md5($_POST['password'])."' && id_num='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update manager set mgr_pass='".md5($_POST['newpassword'])."', updationDate='$currentTime' where id_num='".$_SESSION['alogin']."'");
